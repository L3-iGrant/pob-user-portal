                        ...
                        <Row>
                            <Col md={12} xs={24}>
                                <Space>
                                    ...
                                    <StyledCompanyHeader>{t('MyCompany Wallet')}</StyledCompanyHeader><StyledLogoText className='powered-by-logo-text'>(By <StyledLink target='_blank' href='https://igrant.io'>iGrant.io</StyledLink>)</StyledLogoText>
                                </Space>
                            </Col>
